...
namespace BankProject.TradingFinance.Export.DocumentaryCredit
{
    public partial class DocumentProcessingSettlement : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        ...
        */
        ...
        {
            var lstCharges =
                _entities.BEXPORT_DOCS_PROCESSING_SETTLEMENT_CHARGES.Where(q => q.CollectionPaymentCode == txtCode.Text);
            #region tab Charge
            ...
            if (lstCharges.Any(q => q.Rowchages == "1"))
            {
                ...
                //fixed bug 78 _ remove description
            ...
            else
            {
                ...
                //fixed bug 78 _ remove desciprtion
                //lblPartyCharged3.Text = rcbPartyCharged3.SelectedItem.Attributes["Description"];
...
//                    txtDrawerRefNo.Text = ExLC.DrawerRefNo;
        ...
        {
            var datasource = _entities.BCHARGECODEs.Where(q => q.SettlementELC == "x").ToList();
        ...
        protected void InitDefaultData()
        {
            ...
            tbChargeCode.SelectedValue = "ELC.RECEIVE";
            ...
            tbChargeCode4.SelectedValue = "ELC.SETTLEMENT";
       ...
       /* protected void comboPaymentMethod_OnSelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
                                                                ...
                                                                RadComboBoxSelectedIndexChangedEventArgs e)
        {
            if (comboWaiveCharges.SelectedValue == "NO")
            {
                ...
                divSettlementCharge.Visible = true;
            }
