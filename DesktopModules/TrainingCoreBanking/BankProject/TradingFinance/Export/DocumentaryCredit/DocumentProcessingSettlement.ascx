        ...
        <fieldset>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tbody>
                    ...
                    <tr>
                        <td class="MyLable">1.3 Receving Amount
                        </td>
                        <td class="MyContent">
                            ...
                            <asp:RangeValidator
                                ...
                                ErrorMessage="Receving Amount must be greater than 0" ForeColor="Red">
                            </asp:RangeValidator>
                        </td>
                    </tr>
                    <tr>
    ...
    <div id="Charges" class="dnnClear">
        <fieldset>
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Settlement Charge">
                </telerik:RadTab>
                <%-- hide to fix bug 47 --%>
           ...
           <telerik:RadPageView runat="server" ID="RadPageView4" >
                <div runat="server" ID="divSettlementCharge">
	                <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="MyLable">Charge code</td>
                            <td class="MyContent">
    ...
    <ajaxsettings>
        ...
        <telerik:AjaxSetting AjaxControlID="comboWaiveCharges">
            <UpdatedControls>
                ...
                <telerik:AjaxUpdatedControl ControlID="divSettlementCharge" />    
            </UpdatedControls>
        </telerik:AjaxSetting>
