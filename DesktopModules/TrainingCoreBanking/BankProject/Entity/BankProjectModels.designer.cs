...
namespace BankProject.Entity
{
    ...
    partial void InsertBCOUNTRY(BCOUNTRY_LOCAL instance);
    partial void UpdateBCOUNTRY(BCOUNTRY_LOCAL instance);
    partial void DeleteBCOUNTRY(BCOUNTRY_LOCAL instance);
    #endregion
		...
		public System.Data.Linq.Table<BCOUNTRY_LOCAL> BCOUNTRies
		{
			get
			{
				return this.GetTable<BCOUNTRY_LOCAL>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.BCOUNTRY")]
	public partial class BCOUNTRY_LOCAL : INotifyPropertyChanging, INotifyPropertyChanged
	{
