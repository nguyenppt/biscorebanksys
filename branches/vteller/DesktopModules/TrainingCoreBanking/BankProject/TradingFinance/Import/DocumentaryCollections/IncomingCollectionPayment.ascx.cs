...
namespace BankProject.TradingFinance.Import.DocumentaryCollections
{
    public partial class IncomingCollectionPayment : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        ...
        protected void comboNostroAcct_SelectIndexChange(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
        ...
        protected string PrintMT202()
        {
            ...
            doc.Save("IncomingCollectionPaymentMT202_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".doc",
        ...
        protected void PrintMT400()
        {
            ...
            // Send the document in Word format to the client browser with an option to save to disk or open inside the current browser.
            docMT400.Save("IncomingCollectionPaymentMT400_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".doc",
                          Aspose.Words.SaveFormat.Doc, Aspose.Words.SaveType.OpenInBrowser, Response);
            //docMT400.Save();
            //            
        }
